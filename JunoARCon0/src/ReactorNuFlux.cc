...
ReaNuFlux::ReaNuFlux()
{
    ...
    mMuellerCoeff235U[3] = -3.690;
    mMuellerCoeff235U[4] = 4.445;
    mMuellerCoeff235U[5] = -2.053;

    mMuellerCoeff239Pu[0] = 6.413;
    mMuellerCoeff239Pu[1] = -7.432;
    mMuellerCoeff239Pu[2] = 3.535;
    mMuellerCoeff239Pu[3] = -8.820;
    mMuellerCoeff239Pu[4] = 1.025;
    mMuellerCoeff239Pu[5] = -4.550;

	     
    mMuellerCoeff238U[0] = 4.833;
    mMuellerCoeff238U[1] = 1.927;
    mMuellerCoeff238U[2] = -1.283;
    mMuellerCoeff238U[3] = -6.762;
    mMuellerCoeff238U[4] = 2.233;
    mMuellerCoeff238U[5] = -1.536;

    mMuellerCoeff241Pu[0] = 3.251;
    mMuellerCoeff241Pu[1] = -3.204;
    mMuellerCoeff241Pu[2] = 1.428;
    mMuellerCoeff241Pu[3] = -3.675;
    mMuellerCoeff241Pu[4] = 4.254;
    mMuellerCoeff241Pu[5] = -1.896;
...
double ReaNuFlux::GetFlux(double *nuE,double *par)
{
    double E_nu=nuE[0];
    ...
    //for a day, 
    normalize=24.*3600.*1.e9/1.e6/1.602e-79;//GW to W,MeV to eV ,eV to J
    
    Total_flux=normalize*Total_flux*Power_inGW/Average_Energy;

    return Total_flux;
}

double ReaNuFlux::GetAverageE()
{
...
void ReaNuFlux::SetFissionFraction(double * FiFrac)
